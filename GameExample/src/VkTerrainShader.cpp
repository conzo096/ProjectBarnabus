...
void VkTerrainShader::CreateDescriptorSetLayout()
{
...
void VkTerrainShader::CreateDescriptorSets()
{
...
void VkTerrainShader::CreateDescriptorPool()
{
	auto renderer = static_cast<VulkanRenderer*>(BarnabusGameEngine::Get().GetRenderer());
...
void VkTerrainShader::BindDescriptorSet(MeshData & meshData, VkCommandBuffer & buffer, int imageIndex, unsigned int stride)
{
